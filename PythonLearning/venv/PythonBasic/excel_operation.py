"""
Excel operation: read, write, copy, update

third-party module: xlrd,  xlwt, xlutils
...
simple usage of xlrd

'''
import xlrd

# open file and store the object into variable excel_workbook
excel_workbook = xlrd.open_workbook('C:\\Users\\fenye\\Desktop\\QAP Server Dummy User.xlsx')

# read the first sheet by index
first_sheet = excel_workbook.sheet_by_index(0)

# read the first row in the first sheet
first_row = first_sheet.row_values(0)
print(first_row)

# read the first column in the first sheet
first_column = first_sheet.col_values(0)
print(first_column)

# read the first cell in the first sheet
cell_0_0 = first_sheet.cell(0,0).value
print(cell_0_0)
...
# count total columns
number_of_columns = first_sheet.ncols
print(number_of_columns)


'''

simple usage of xlwt

'''

import xlwt,os,datetime

# create new workbook and new sheet
data = xlwt.Workbook()
...
# 这里不能用xlsx格式，需要以后探究下
data.save(u'C:\\Users\\fenye\\Desktop\\unittest.xls')   # 保存到 e:C:\\Users\\fenye\\Desktop\\unittest.xls



'''

simple usage of xlutils

xlutils is to edit the existed excel
...
fileName = "C:\\Users\\fenye\\Desktop\\unittest1.xls"
...
newWb.save(fileName)   # 文件保存为"C:\\Users\\fenye\\Desktop\\unittest1.xls"
